...
interface ExamProviderScreenProps {
...
export function ExamProviderScreen({ onContinue, onBack, onClose, isActive, bookingData, isComboFlow }: ExamProviderScreenProps) {
                ...
                <div className="px-5 pb-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {provider.designations.map((designation) => (
                        <span
                          key={designation}
